	...
	<body>
		...
		<?php include_once("navbar.php"); ?> <!-- Includes the navigation bar -->
			...
			<div class="inputbox">
				<!-- account -->
				<div>
					<div><h1> Your Details: </h1></div><!-- class="text_student_account" not loading but otherwise the styles are correct -->
						<div>
				...
				<div> <h1>Change your details: </h1></div>	
				<div>
				...
				<form id="change_details" action="updateUser.php" method="post"> <!-- Form that posts the users information to the resubbmit_details  -->
					...
					<center><input type="button" class="button" id="normal_button" value="Submit" onclick="myFunction()"/></center>
				</form>
			</div>
